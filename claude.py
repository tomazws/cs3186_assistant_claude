...
def getCompletion(prompt):
    ...
    with st.spinner('Thinking ...'):
        ...
        st.session_state.messages.append({'role': 'assistant', 'content': response.content[0].ContentBlock.text})
        displayMessage('assistant', response.content[0].ContentBlock.text)
